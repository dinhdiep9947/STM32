/*
This is library based on TM's library
*/
...
/* Flush FIFOs */
#define NRF24L01_FLUSH_TX					do { NRF24L01_CSN_LOW; HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_FLUSH_TX_MASK, 1, 1000); NRF24L01_CSN_HIGH; } while (0)
#define NRF24L01_FLUSH_RX					do { NRF24L01_CSN_LOW; HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_FLUSH_RX_MASK, 1, 1000); NRF24L01_CSN_HIGH; } while (0)
...
uint8_t NRF24L01_ReadRegister(uint8_t reg)
{
	uint8_t value;
	NRF24L01_CSN_LOW;
	HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_READ_REGISTER_MASK(reg), 1, 1000);
	HAL_SPI_TransmitReceive(&NRF24L01_SPI, (uint8_t *)NRF24L01_NOP_MASK, &value, 1, 1000);
	NRF24L01_CSN_HIGH;
...
{
	NRF24L01_CSN_LOW;
	HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_WRITE_REGISTER_MASK(reg), 1, 1000);
	HAL_SPI_TransmitReceive(&NRF24L01_SPI, data, (uint8_t *)NRF24L01_NOP_MASK, count, 1000);
	NRF24L01_CSN_HIGH;
}
...
void NRF24L01_WriteRegister(uint8_t reg, uint8_t value)
{
	NRF24L01_CSN_LOW;
	HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_WRITE_REGISTER_MASK(reg), 1, 1000);
	HAL_SPI_Transmit(&NRF24L01_SPI, &value, 1, 1000);
	NRF24L01_CSN_HIGH;
}
...
void NRF24L01_WriteRegisterMulti(uint8_t reg, uint8_t *data, uint8_t count)
{
	NRF24L01_CSN_LOW;
	HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_WRITE_REGISTER_MASK(reg), 1, 1000);
	HAL_SPI_Transmit(&NRF24L01_SPI, data, count, 1000);
	NRF24L01_CSN_HIGH;
}
...
void NRF24L01_Transmit(uint8_t *data)
{
	...
	HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_W_TX_PAYLOAD_MASK, 1, 1000);
...
void NRF24L01_GetData(uint8_t* data)
{
	...
	HAL_SPI_Transmit(&NRF24L01_SPI, (uint8_t *)NRF24L01_R_RX_PAYLOAD_MASK, 1, 1000);
	/* Read payload */
	HAL_SPI_TransmitReceive(&NRF24L01_SPI, data, data, NRF24L01_Struct.PayloadSize, 1000);
	/* Pull up chip select */
	NRF24L01_CSN_HIGH;
	
	/* Reset status register, clear RX_DX interrupt flag */
...
uint8_t NRF24L01_GetStatus(void)
{
	...
	HAL_SPI_TransmitReceive(&NRF24L01_SPI, (uint8_t *)NRF24L01_NOP_MASK, &status, 1, 1000);
	/* Pull up chip select */
	NRF24L01_CSN_HIGH;
...
NRF24L01_Transmit_Status_t NRF24L01_GetTransmissionStatus(void)
{
	...
	else if (NRF24L01_CHECK_BIT(status, NRF24L01_MASK_MAX_RT)) 
	{
		/* Message lost */
...
{
	NRF24L01_WriteRegister(0x07, 0x07);
}
